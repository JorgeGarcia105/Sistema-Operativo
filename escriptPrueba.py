...
from mainPrueba import DesktopWindow
...
class LoginWidget(QWidget):
    ...
    def login(self):
        ...
        if entered_username == self.expected_username and entered_password == self.expected_password:
            ...
            # Abrir el escritorio después del inicio de sesión exitoso
            self.open_desktop()
        else:
    ...
    def open_desktop(self):
        self.desktop = DesktopWindow(self.expected_username)
        self.desktop.show()
...
def main():
    ...
    with open('./Recursos/json/profiles.json', 'r') as jsonfile:
